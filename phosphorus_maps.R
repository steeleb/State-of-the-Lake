...
#sunapee shoreline
sunapee_shore = st_read(file.path(feat_dir, 'hydrography/LS_shore_WGS.shp'))
#bathy
sun_bathy <- raster(file.path(feat_dir, 'Sunapee Bathymetry/raster_files/originals/sun_ras_z_m'))
#sunpaee tribs
sun_trib <- st_read(file.path(feat_dir, 'hydrography/streams.shp'))
sun_trib_wgs <- st_transform(sun_trib, crs = 'EPSG:4326')
#sunapee open water
sun_ws_water <- st_read(file.path(feat_dir, 'hydrography/waterbodies open water.shp'))
...
# paneled_meantp
# tmap_save(paneled_meantp, filename = file.path(dump_dir, paste0('mean_tp_summer_paneled_',startyear,'-',end_10_year,'.png')),
#           width = 8,
#           height = 6,
#           units = 'in',
#           dpi = 300)
...
#             panel.label.bg.color = 'white')
# paneled_medtp
# tmap_save(paneled_medtp, filename = file.path(dump_dir, paste0('med_tp_summer_paneled_',startyear, '-', end_10_year, '.png')),
#           width = 8,
#           height = 6,
#           units = 'in',
#           dpi = 300)
...
# paneled_meantp_trib
# 
# tmap_save(paneled_meantp_trib, filename = file.path(dump_dir, paste0('mean_tp_summer_trib_paneled_', startyear, '-', end_10_year, '.png')),
#           width = 9,
#           height = 6,
#           units = 'in',
#           dpi = 300)
...
# paneled_medtp_trib
# 
# tmap_save(paneled_medtp_trib, filename = file.path(dump_dir, paste0('med_tp_summer_trib_paneled_', startyear, '-', end_10_year, '.png')),
#           width = 9,
#           height = 6,
#           units = 'in',
#           dpi = 300)
...
lt_tp_med <- tm_shape(sunapee_shore, bbox = bbox_sun_ws) + tm_polygons() +
  ...
  tm_layout(legend.outside = T,
            ...
            title.fontface = 'bold')
lt_tp_med
tmap_save(lt_tp_med, filename = file.path(dump_dir, paste0('median_longterm_tp_', start_10_year, '-', end_10_year, '.png')),
          height = 6, width =5, dpi = 300)
